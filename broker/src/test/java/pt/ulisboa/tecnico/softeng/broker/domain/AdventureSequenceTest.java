...
public class AdventureSequenceTest extends RollbackTestAbstractClass {
    ...
    @Test
    public void successSequence(@Mocked final BankInterface bankInterface,
    ...
    @Test
    public void successSequenceOneNoCar(
    ...
    @Test
    public void successSequenceNoHotel(
            @Mocked final BankInterface bankInterface, @Mocked final ActivityInterface activityInterface,
            @Mocked CarInterface carInterface) {
    ...
    @Test
    public void successSequenceNoHotelNoCar(
            @Mocked final BankInterface bankInterface, @Mocked final ActivityInterface activityInterface) {
    ...
    @Test
    public void unsuccessSequenceFailHotel(@Mocked final BankInterface bankInterface,
                                           @Mocked final ActivityInterface activityInterface) {
    ...
    @Test
    public void unsuccessSequenceFailCar(
            @Mocked final BankInterface bankInterface, @Mocked final ActivityInterface activityInterface,
            @Mocked final CarInterface carInterface) {
    ...
    @Test
    public void unsuccessSequenceFailPayment(
            @Mocked final BankInterface bankInterface, @Mocked final ActivityInterface activityInterface,
            @Mocked final CarInterface carInterface) {
    ...
    @Test
    public void unsuccessSequenceFailTax(@Mocked final BankInterface bankInterface,
                                         @Mocked final ActivityInterface activityInterface,
                                         @Mocked final CarInterface carInterface) {
