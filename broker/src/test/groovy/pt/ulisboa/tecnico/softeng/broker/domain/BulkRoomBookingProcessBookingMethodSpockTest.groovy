...
class BulkRoomBookingProcessBookingMethodSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def 'success'() {
        ...
        hotelInterface.bulkBooking(NUMBER_OF_BULK, ARRIVAL, DEPARTURE, BROKER_NIF, IBAN_BUYER,
    ...
    def 'success twice'() {
        ...
        0 * hotelInterface.bulkBooking(NUMBER_OF_BULK, ARRIVAL, DEPARTURE, BROKER_NIF, IBAN_BUYER,
                bulk.getId())
        bulk.getReferences().size() == 2
