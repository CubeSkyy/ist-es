...
class ActivityPersistenceSpockTest extends SpockPersistenceTestAbstractClass {
    ...
    def thenAssert() {
        ...
        def providers = new ArrayList<ActivityProvider>(FenixFramework.getDomainRoot().getActivityProviderSet())
        ...
        def activities = new ArrayList<Activity>(provider.getActivitySet())
        ...
        def offers = new ArrayList<ActivityOffer>(activity.getActivityOfferSet())
        ...
        def bookings = new ArrayList<Booking>(offer.getBookingSet())
