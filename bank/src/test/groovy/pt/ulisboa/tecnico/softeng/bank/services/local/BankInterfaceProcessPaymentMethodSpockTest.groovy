...
class BankInterfaceProcessPaymentMethodSpockTest extends SpockRollbackTestAbstractClass {
    ...
    def 'success two banks'() {
        ...
        when:
        BankInterface.processPayment(new BankOperationData(otherIban, iban, 100, TRANSACTION_SOURCE, TRANSACTION_REFERENCE))
    ...
    def 'problem process payment'() {
        ...
        ibn     | ibn2  | val | label
        null    | null  | 100 | 'null iban'
        '  '    | iban2 | 100 | 'blank iban'
        iban    | '  '  | 100 | 'blank iban2'
        ''      | iban2 | 100 | 'empty iban'
        iban    | ''    | 100 | 'empty iban2'
